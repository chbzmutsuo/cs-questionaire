			...
			{questions.map((item, index) => {
				...
				return (
					<div key={index}>
						<ListGroup.Item
							as="li"
							className="d-flex  p-1 justify-content-between align-items-start text-left"
						>
							...
							<div className="ms-2 w-full">
								...
								<div className='my-2'>
									<div className='' >
										<span data-question-number={index} className=' underline font-bold text-blue-400  underline-offset-2 p-2'
